...
function setUpDOM(data) {
    ...
    for(var i = 0; i < data["tasks"].length; i++) {
        ...
        var link =  "http://uaf-4.t2.ucsd.edu/~fgolf/dis/?type=basic&short=true&query="+general["dataset"];
        var link_handler =  "http://uaf-4.t2.ucsd.edu:8887/dis/serve?type=basic&short=true&query="+general["dataset"];
